        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult?) {
                ...
                if (locationResult?.lastLocation != null) {
                    ...
                    Commons.homeActivity.myLatLng = Commons.homeActivity.getMyLatLng(currentLocation)
                    ...
                    if (serviceRunningInForeground) {
                        Log.d("BACKGROUND LOCATION : ", currentLocation.toString());
...
//                                generateNotification(currentLocation))
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val activityPendingIntent = PendingIntent.getActivity(
                this, 0, launchActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_MUTABLE)
