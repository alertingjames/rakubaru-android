...
public class ReportListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null) {
            ...
            holder.assignTitleBox = (TextView) convertView.findViewById(R.id.assignTitleBox);
        ...
        if(entity.getArea_name().length() > 0) {
            holder.areaNameBox.setVisibility(View.VISIBLE);
            holder.areaNameBox.setText(entity.getArea_name());
        }else holder.areaNameBox.setVisibility(View.GONE);

        if(entity.getAssign_title().length() > 0) {
            holder.assignTitleBox.setVisibility(View.VISIBLE);
            holder.assignTitleBox.setText(entity.getAssign_title());
        }else holder.assignTitleBox.setVisibility(View.GONE);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                _context.getReportDetails(entity);
            }
        });
    ...
    class CustomHolder {
        ...
        TextView areaNameBox, assignTitleBox;
    }
}
