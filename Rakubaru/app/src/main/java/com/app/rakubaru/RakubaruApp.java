...
public class RakubaruApp extends Application {
    public static final String TAG = RakubaruApp.class.getSimpleName();

    private String m_gsmToken = "";

    private static final String LOG_TAG = "CrashCatch";

    private static RakubaruApp _instance;

    public static RakubaruApp getApplication() {
        return _instance;
    }
    ...
    public static synchronized RakubaruApp getInstance(){
